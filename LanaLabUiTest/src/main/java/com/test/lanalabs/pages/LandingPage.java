...
public class LandingPage {
	...
	public LandingPage clickOnLandingPagePopUpRadioButton() {
	...
	public LandingPage clickOnLandingPagePopUpSelectedButton() {
	...
	public LandingPage clickOnModalViewPopUp() {
	...
	public LandingPage clickOnLandingPageHorizontalBars() throws InterruptedException {
		Thread.sleep(3000);
	...
	public LandingPage clickOnFilterAttribute() {
	...
	public LandingPage clickOnFilterAttributeSerachFieldPopUp(String textToSerach) throws InterruptedException {
	...
	public LandingPage clickOnFilterAttributePopUpCountryCheckBox() throws InterruptedException {
	...
	public LandingPage clickOnfilterAttriutbutePopUpSaveButton() throws InterruptedException {
	...
	public LandingPage  clickOnFirstSegment()  {
